...
meaning that every shortcuts must be prepended by `Ctrl` and/or `Alt`; this
phenomenon is so prevalent that people coined a specific term for RSI caused by
using your pinky finger to access modifier keys too often:
